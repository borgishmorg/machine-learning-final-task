...
random_forest = GradientBoostingClassifier(random_state=1)
gscv = GridSearchCV(
    random_forest,
    params,
    scoring=scoring,
...
scores = cross_validate(
    GradientBoostingClassifier(random_state=1, **gscv.best_params_),
...
random_forest = GradientBoostingClassifier(random_state=1).fit(X_train, y_train)
...
tree = GradientBoostingClassifier(random_state=1, **gscv.best_params_)
tree.fit(X, y)
